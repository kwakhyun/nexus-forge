...
export function createPlantSummary(now = Date.now()): PlantSummary {
  ...
  return {
    ...
    activeIncident: {
      ...
      startedAt,
      confidence: 0.92,
      causalChain: ["댄서 롤 편위", "웹 장력 상승", "엣지 웨이브 결함"],
      safeToVerifyWhileRunning: true,
      status: "open",
      evidence: [
        { id: "EV-01", label: "댄서 롤 위치 편위", value: "+12.4 mm", observedAt: startedAt - 251_000 },
        { id: "EV-02", label: "웹 장력 좌/우 동시 상승", value: "+34.2 N", observedAt: startedAt - 11_000 },
        { id: "EV-03", label: "비전 엣지 웨이브 결함률", value: "1.92%", observedAt: startedAt + 9_000 },
      ],
    },
  };
}
